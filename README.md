...
| ytdlDubLanguage                | Set preferred audio language for AVPro and cached videos, e.g. `en` for English, check list of [supported lang codes](https://github.com/yt-dlp/yt-dlp/blob/c26f9b991a0681fd3ea548d535919cec1fbbd430/yt_dlp/extractor/youtube.py#L381-L390)          |
...
| CacheYouTubeMaxLength          | Maximum video duration in minutes, e.g. `180` for 3 hours.                                                                                                                                                                                          |
