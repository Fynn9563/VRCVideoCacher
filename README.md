...
| ytdlArgsOverride          | Override the default yt-dlp arguments completely (advanced users only). When set, this replaces `ytdlAdditionalArgs`.                                                                                                                                                                          |
| avproOverride             | Force AVPro mode for all video requests. Useful if you always want browser impersonation enabled.                                                                                                                                                                                              |
| CacheCustomDomains        | List of custom domains to cache videos from, e.g. `["example.com", "cdn.mysite.net"]`. Videos are organized into subdirectories by domain.                                                                                                                                                     |
| ClearYouTubeCacheOnExit   | Automatically clear YouTube cached videos when VRCVideoCacher exits.                                                                                                                                                                                                                           |
| ClearPyPyDanceCacheOnExit | Automatically clear PyPyDance cached videos when VRCVideoCacher exits.                                                                                                                                                                                                                         |
| ClearVRDancingCacheOnExit | Automatically clear VRDancing cached videos when VRCVideoCacher exits.                                                                                                                                                                                                                         |
| ClearCustomDomainsOnExit  | List of custom domains to clear cache on exit, e.g. `["example.com"]`. Only domains in this list will be cleared.                                                                                                                                                                              |
